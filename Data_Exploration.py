...
# balance dataset by dropping 23,000 '>30' data points to reduce data set to a little over 12,000 '>30' data points
over_30 = dataset[dataset['readmitted'] == '>30'].index
over_30 = over_30[0:23000]
dataset = dataset.drop(index=over_30)

dataset = dataset.sample(frac=1, random_state=1)    # shuffle data set
